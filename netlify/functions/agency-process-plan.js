...
// Returns immediately — background function does the Claude work
...
export default async (req) => {
  ...
  try {
    ...
    // 3. Save client to Firestore immediately (status: new, no plan yet)
    ...
    // 4. Trigger background function — fire and forget
    // Background function has 15-min timeout and will call Claude + update Firestore

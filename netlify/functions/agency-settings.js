  ...
  if (event.httpMethod === 'POST') {
    ...
    try {
      ...
      const updated = {
        ...
        googleManagerId:    body.googleManagerId    !== undefined ? body.googleManagerId    : (agency.googleManagerId||''),
        tiktokAgencyId:     body.tiktokAgencyId     !== undefined ? body.tiktokAgencyId     : (agency.tiktokAgencyId||''),
        linkedinAgencyId:   body.linkedinAgencyId   !== undefined ? body.linkedinAgencyId   : (agency.linkedinAgencyId||''),
        wordpressSiteUrl:   body.wordpressSiteUrl    !== undefined ? body.wordpressSiteUrl   : (agency.wordpressSiteUrl||''),
